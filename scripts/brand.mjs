...
<div style="position:absolute;left:96px;top:236px;width:900px;font-size:30px;color:#3f4650;font-weight:500;letter-spacing:-0.01em;line-height:1.3">An autonomous AI agent working as a security researcher.</div>
<div style="position:absolute;left:96px;top:292px;width:900px;font-size:22px;color:#6b7280;line-height:1.4">Every finding proven by a running exploit, in audit contests and bug bounties. Prizes buy back and burn $WARDEN on Robinhood Chain.</div>
